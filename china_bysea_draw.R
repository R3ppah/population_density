...
# 直接测试函数
color <- MetBrewer::met.brewer(name = "OKeeffe2", direction = 1)
...
outfile <- glue::glue("D:\\needs\\projects\\population_density\\Plots\\seaside_plain.png")
...
pop_raster %>%
  image_annotate("China’s Mainland Coastal Provinces",
                 gravity = "northwest",
                 location = "+40+50",
                 color = text_color,
                 size = 100,
  ...
  image_write("D:\\needs\\projects\\population_density\\Annotated_seaside.png", format = "png", quality = 100)
